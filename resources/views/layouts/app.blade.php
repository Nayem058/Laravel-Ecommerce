...
<head>
    ...
    <!--dataTable-->
    <link rel="stylesheet"
        href="{{ asset('/') }}assets/admin/vendor/data-table/media/css/dataTables.bootstrap.min.css">
    <!-- ========================================================= -->
    <!--Notification msj-->
                            ...
                            <ul class="nav nav-left-lines" id="main-nav">
                                ...
                                <li
                                    ...
                                    <ul class="nav child-nav level-1">
                                        ...
                                        href="{{ route('manage-brand') }}">Manege Brand</a></li>
                                    </ul>
                                </li>
                                 ...
                                 <ul class="nav child-nav level-1">
                                    ...
                                    <a href="{{ route('manage-category') }}">Category</a></li>
                                     ...
                                     <li class="{{ request()->is('category/manage-sub-category','category/add-sub-category') ? 'active-item' : '' }}">
                                    <a href="{{ route('manage-subcategory') }}">Sub Category</a></li>
